...
class Constants(BaseConstants):
    name_in_url = 'csr_quiz_wg_30'
    players_per_group = 2
    task_timer = 270
    num_rounds = 5
    instructions_template = 'csr_1_quiz_30/instruc.html'
        ...
        questions = [
            {
                ...
                'quiz_sol':(10 + 40 * 0.30),
                'quiz_sol_text':'csr_1_quiz_30/sol/quiz1sol.html'
            },
            {
                ...
                'quiz_sol':(10 + 40 * 0.30),
                'quiz_sol_text':'csr_1_quiz_30/sol/quiz2sol.html'
            },
            {
                ...
                'quiz_sol':(20 + 30 * 0.30),
                'quiz_sol_text':'csr_1_quiz_30/sol/quiz3sol.html'
            },
            {
                ...
                'quiz_sol':(50 * 0.30),
                'quiz_sol_text':'csr_1_quiz_30/sol/quiz4sol.html'
            },
            {
                ...
                'quiz_sol':(10 + 70 * 0.30),
                'quiz_sol_text':'csr_1_quiz_30/sol/quiz5sol.html'
            },
        ]


        for i in range(len(questions)): # range here is number of questions
            Qz.questions.extend([questions[i]])

        for i in range(len(Qz.questions)):

            for p in self.get_players():
                if self.round_number == (i+1):
                    p.mpcr = 0.30  
                    p.quiz_text = Qz.questions[i]['quiz_text']
                    p.quiz_sol = Qz.questions[i]['quiz_sol']
                    p.quiz_sol_text = Qz.questions[i]['quiz_sol_text']
