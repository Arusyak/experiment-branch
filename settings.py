...
SESSION_CONFIGS = [
    ...
    {
        'name': 'csr_sjur_prod_75',
        'display_name': "CSR PROD: RET, VCM+quiz, and STAGE+quiz | MPCR = 75%",
        'num_demo_participants': 4,
        'app_sequence': [
            'csr_0_realeffort', 'csr_1_quiz','csr_2_vcm','csr_sjurBot',
        ],
        'real_world_currency_per_point': 1.0,
        'vcm_round_count': 10, # Doesn't deal well with less than 10 rounds -- man advancing seems to do the trick
        'stage_round_count': 10,
        'ret_time': 150,
        'GE_min':5,
        'GE_max':95,
        'participation_fee': 600.0, #30*20
        'final_score_discounter':8, # 0.4*20
        'GE_Low_A':15,
        'GE_Low_F':5,
        'mpcr':0.75,
        'boycott_cost':10,
    ...
    {
        'name': 'csr_sjur_test_75',
        'display_name': "CSR TEST: RET, VCM+quiz, and STAGE+quiz | MPCR = 75%",
        'num_demo_participants': 4,
        'app_sequence': [
            'csr_0_realeffort', 'csr_1_quiz','csr_2_vcm','csr_sjurBot',
        ],
        'real_world_currency_per_point': 1.0,
        'vcm_round_count': 2, # Doesn't deal well with less than 10 rounds -- man advancing seems to do the trick
        'stage_round_count': 2,
        'ret_time': 30,
        'GE_min':5,
        'GE_max':95,
    ...
    {
        'name': 'csr_sjur_prod_30',
        'display_name': "CSR PROD: RET, VCM+quiz, and STAGE+quiz | MPCR = 30%",
        'num_demo_participants': 4,
        'app_sequence': [
            'csr_0_realeffort', 'csr_1_quiz_30','csr_2_vcm','csr_sjurBot_30',
        ],
        'real_world_currency_per_point': 1.0,
        'vcm_round_count': 10, # Doesn't deal well with less than 10 rounds -- man advancing seems to do the trick
        'stage_round_count': 10,
    ...
    {
        'name': 'csr_sjur_test_30',
        'display_name': "CSR TEST: RET, VCM+quiz, and STAGE+quiz | MPCR = 30%",
        'num_demo_participants': 4,
        'app_sequence': [
            'csr_0_realeffort', 'csr_1_quiz_30','csr_2_vcm','csr_sjurBot_30',
        ],
...
'''
    {
        ...
        'real_world_currency_per_point': 1.0,
        'ret_time': 300, #Has to be changed here too SH
        'vcm_round_count': 10,
        'GE_min':5,
        'GE_max':95,
        ...
        },
    {
        ...
        'boycott_cost':10,
        'passive_ge_contrib':40,
        'A1_A_mult':1.0, # Mults disabled, exc. F1
        'A1_F_mult':1.0,
        'F1_A_mult':1.0,
        'F1_F_mult':3.0, # ensure that (F1_F_mult * (GE_Low_F)) < 20, otherwise things break. 
        'A3_A_mult':1.0,
